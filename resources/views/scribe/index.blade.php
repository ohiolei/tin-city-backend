            ...
            <ul id="tocify-header-routes-management" class="tocify-header">
                ...
                <ul id="tocify-subheader-routes-management" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="routes-management-GETapi-v1-routes-export">
                        <a href="#routes-management-GETapi-v1-routes-export">Export all static routes in JSON format for
                            mobile app usage.</a>
                    </li>
                    ...
                    <li class="tocify-item level-2" data-unique="routes-management-PUTapi-v1-routes--route_id-">
                        <a href="#routes-management-PUTapi-v1-routes--route_id-">Update an existing route (Admin
                            only).</a>
                    </li>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-notifications-test" data-method="POST" data-path="api/v1/notifications/test"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-notifications-test" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-v1-notifications-test" value="application/json"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="token"
                        data-endpoint="POSTapi-v1-notifications-test" value=""dYV1S2A4-abc123xyz""
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="title"
                        data-endpoint="POSTapi-v1-notifications-test" value=""Reward Earned""
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="body"
                        data-endpoint="POSTapi-v1-notifications-test" value=""You received 50 bonus points!""
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="type"
                        data-endpoint="POSTapi-v1-notifications-test" value=""reward"" data-component="body">
                    <br>
                    <p>optional The type of notification. Must be one of: reward, route_update, admin_alert. Example:
                        <code>"reward"</code></p>
                </div>
            </form>
            ...
            <h2 id="routes-management-GETapi-v1-routes-export">Export all static routes in JSON format for mobile app
                usage.</h2>
...
<code class="language-json" style="max-height: 300px;">{
  ...
  &quot;routes&quot;: [...]
            ...
            <span id="execution-results-GETapi-v1-routes-export" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-routes-export"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-routes-export" data-method="GET" data-path="api/v1/routes/export"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-routes-export" onclick="tryItOut('GETapi-v1-routes-export');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-routes-export" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-v1-routes-export" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
    ...
    &quot;data&quot;: [
        {
            ...
            <span id="execution-results-GETapi-v1-routes" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-routes"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-routes" data-method="GET" data-path="api/v1/routes" data-authed="0"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-routes" onclick="tryItOut('GETapi-v1-routes');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-v1-routes" onclick="cancelTryOut('GETapi-v1-routes');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-routes" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-v1-routes"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-v1-routes"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;error&quot;: &quot;Route not found&quot;
            ...
            <span id="execution-results-GETapi-v1-routes--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-v1-routes--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-v1-routes--id-" data-method="GET" data-path="api/v1/routes/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-v1-routes--id-" onclick="tryItOut('GETapi-v1-routes--id-');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-v1-routes--id-" onclick="cancelTryOut('GETapi-v1-routes--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-v1-routes--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-v1-routes--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-v1-routes--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="GETapi-v1-routes--id-" value="1" data-component="url">
                    <br>
    ...
    &quot;data&quot;: {
        ...
        &quot;created_at&quot;: &quot;2025-10-18T12:00:00Z&quot;
            ...
            <span id="execution-results-POSTapi-v1-routes" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-v1-routes"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-routes" data-method="POST" data-path="api/v1/routes" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-v1-routes" onclick="tryItOut('POSTapi-v1-routes');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-v1-routes" onclick="cancelTryOut('POSTapi-v1-routes');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-routes" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-v1-routes" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-v1-routes"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-v1-routes"
                        value="Terminus to Bukuru" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="start_point" data-endpoint="POSTapi-v1-routes"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="end_point" data-endpoint="POSTapi-v1-routes"
                        value="g" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="encoded_polyline"
                        data-endpoint="POSTapi-v1-routes" value="mfp_Ijk~hEo}@yDa@e..." data-component="body">
                    <br>
                    <p>Google Maps encoded polyline representing the route path. Example:
                        <code>mfp_Ijk~hEo}@yDa@e...</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    <b style="line-height: 2;"><code>distance_km</code></b>&nbsp;&nbsp;
                    <small>number</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="distance_km"
                        data-endpoint="POSTapi-v1-routes" value="39" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            <small>string</small>&nbsp;
                            <i>optional</i> &nbsp;
                            <input type="text" style="display: none" name="stops.0.name"
                                data-endpoint="POSTapi-v1-routes" value="architecto" data-component="body">
                            <br>
                            <p>This field is required when <code>stops</code> is present. Example:
                                <code>architecto</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            <b style="line-height: 2;"><code>latitude</code></b>&nbsp;&nbsp;
                            <small>number</small>&nbsp;
                            <i>optional</i> &nbsp;
                            <input type="number" style="display: none" step="any" name="stops.0.latitude"
                                data-endpoint="POSTapi-v1-routes" value="4326.41688" data-component="body">
                            <br>
                            <p>This field is required when <code>stops</code> is present. Example:
                                <code>4326.41688</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            <b style="line-height: 2;"><code>longitude</code></b>&nbsp;&nbsp;
                            <small>number</small>&nbsp;
                            <i>optional</i> &nbsp;
                            <input type="number" style="display: none" step="any" name="stops.0.longitude"
                                data-endpoint="POSTapi-v1-routes" value="4326.41688" data-component="body">
                            <br>
                            <p>This field is required when <code>stops</code> is present. Example:
                                <code>4326.41688</code></p>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            <small>integer</small>&nbsp;
                            <i>optional</i> &nbsp;
                            <input type="number" style="display: none" step="any" name="stops.0.order_index"
                                data-endpoint="POSTapi-v1-routes" value="16" data-component="body">
                            <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>number</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="distance"
                        data-endpoint="POSTapi-v1-routes" value="8.3" data-component="body">
                    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;error&quot;: &quot;You are not authorized to perform this action&quot;
            ...
            <span id="execution-results-PUTapi-v1-routes--route_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-v1-routes--route_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-v1-routes--route_id-" data-method="PUT" data-path="api/v1/routes/{route_id}"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-v1-routes--route_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="route_id"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="16" data-component="url">
                    <br>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="route"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="name"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="architecto" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="start_point"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="n" data-component="body">
                    <br>
                    <p>Must not be greater than 255 characters. Example: <code>n</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="end_point"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="g" data-component="body">
                    <br>
                    <p>Must not be greater than 255 characters. Example: <code>g</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="distance_km"
                        data-endpoint="PUTapi-v1-routes--route_id-" value="39" data-component="body">
                    <br>
                    <p>Must be at least 0. Example: <code>39</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            <i>optional</i> &nbsp;
                            <input type="number" style="display: none" step="any" name="stops.0.latitude"
                                data-endpoint="PUTapi-v1-routes--route_id-" value="4326.41688" data-component="body">
                            <br>
                            <p>This field is required when <code>stops</code> is present. Example:
                                <code>4326.41688</code></p>
                        </div>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            <i>optional</i> &nbsp;
                            <input type="number" style="display: none" step="any" name="stops.0.order_index"
                                data-endpoint="PUTapi-v1-routes--route_id-" value="16" data-component="body">
                            <br>
                            <p>This field is required when <code>stops</code> is present. Example: <code>16</code></p>
                        </div>
                    </details>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-v1-routes--route_id-" data-method="DELETE" data-path="api/v1/routes/{route_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-v1-routes--route_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-v1-routes--route_id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="route_id"
                        data-endpoint="DELETEapi-v1-routes--route_id-" value="16" data-component="url">
                    <br>
                    <p>The ID of the route. Example: <code>16</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="route"
                        data-endpoint="DELETEapi-v1-routes--route_id-" value="1" data-component="url">
                    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Invalid credentials&quot;
            ...
            <span id="execution-results-POSTapi-v1-login" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-v1-login"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-v1-login" data-method="POST" data-path="api/v1/login" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-v1-login" onclick="tryItOut('POSTapi-v1-login');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-v1-login" onclick="cancelTryOut('POSTapi-v1-login');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-v1-login" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-v1-login"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-v1-login"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="email" data-endpoint="POSTapi-v1-login"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="password" data-endpoint="POSTapi-v1-login"
                        value="password" data-component="body">
                    <br>
