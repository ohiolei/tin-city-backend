...
<<<<<<< HEAD
                                ...
                                <a href="#endpoints-GETapi-v1-routes">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-routes--id-">
                                <a href="#endpoints-GETapi-v1-routes--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-routes">
                                <a href="#endpoints-POSTapi-v1-routes">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-routes--route_id-">
                                <a href="#endpoints-PUTapi-v1-routes--route_id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-routes--route_id-">
                                <a href="#endpoints-DELETEapi-v1-routes--route_id-">Remove the specified resource from storage.</a>
                            </li>
